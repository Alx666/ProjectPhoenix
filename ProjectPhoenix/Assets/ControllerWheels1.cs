...
public class ControllerWheels1 : NetworkBehaviour, IControllerPlayer
{
    ...
    void Start()
    {
        ...
        if (OverrideCenterOfMass)
            ...
            GameObject camera =  GameObject.Instantiate(m_hCamera);
            CustomCamera1 custom =    camera.GetComponent<CustomCamera1>();
            custom.Target = this.gameObject;
            custom.enabled = true;
    ...
    {
        private ControllerWheels1 m_hOwner;
        public GroundState(ControllerWheels1 hOwner)
        {
            m_hOwner = hOwner;
        }
    ...
    {
        private ControllerWheels1 m_hOwner;
        public FlyState(ControllerWheels1 hOwner)
        {
            m_hOwner = hOwner;
        }
    ...
    private class TurnedState : IFlyState
    {
        ...
        public TurnedState(ControllerWheels1 hOwner, Vector3 vTurnOverride)
        {
            m_hOwner = hOwner;
