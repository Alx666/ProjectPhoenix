...
namespace PhoenixVehSelection
{
    public class PhoenixVehicleSelection : MonoBehaviour
    {
        ...
        private Dictionary<GameObject, string> m_hVehicleNames;
        ...
        void Awake()
        {
            ...
            m_hVehicleNames = new Dictionary<GameObject, string>();
            Vehicles.ForEach(hV =>
            {
                ...
                {
                    m_hVehicleNames.Add(hNew, m_sVname);
                }
                else
                {
                    m_hVehicleNames.Add(hNew, hNew.ToString());
                }
            });
        ...
        void Start()
        {
            ...
            CarNameText.text = m_hVehicleNames[m_hCurrent.Value];
        }
